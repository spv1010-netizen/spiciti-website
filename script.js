...
function updateCheckoutActionButtons() {
  var isDesktop = state.checkoutModal.deviceType === "desktop";
  ...
  setCheckoutNodesHidden("[data-checkout-open-upi]", !hasUpi || isDesktop);
  setCheckoutNodesDisabled("[data-checkout-open-upi]", !hasUpi || isDesktop);
...
function openUPI() {
  ...
  if (state.checkoutModal.deviceType !== "mobile") {
    if (state.checkoutModal.deviceType === "desktop") {
...
function handleDocumentClick(event) {
  ...
  const openUpiButton = event.target.closest("[data-checkout-open-upi]");
  const openWhatsAppButton = event.target.closest("[data-checkout-open-whatsapp]");
  const openEmailButton = event.target.closest("[data-checkout-open-email]");
